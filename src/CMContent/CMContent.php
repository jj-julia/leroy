...
class CMContent extends CObject implements IHasSQL, ArrayAccess {
  ...
  public function Init() {
    try {
      ...
      $this->db->ExecuteQuery(self::SQL('insert content'), array('home', 'page', 'Home page', "This is a demo page, this could be your personal home-page.\n\nLeroy is a PHP-based MVC-inspired Content management Framework based on Lydia (an MVC framework of another name), watch the making of Lydia at: http://dbwebb.se/lydia/tutorial.", 'plain', $this->user['id']));
