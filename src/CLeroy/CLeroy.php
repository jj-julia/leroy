<?php
/**
 * Main class for Leroy, holds everything.
 *
 * @package LeroyCore
 */
class CLeroy implements ISingleton {
  ...
  protected function __construct() {
    ...
    $ly = &$this;
    require(LEROY_SITE_PATH.'/config.php');
   ...
   * @return CLeroy The instance of this class.
   */
  public static function Instance() {
    if(self::$instance == null) {
      self::$instance = new CLeroy();
    }
  ...
  public function ThemeEngineRender() {
    ...
    $ly = &$this;
    include(LEROY_INSTALL_PATH . '/themes/functions.php');
